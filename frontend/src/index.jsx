...
const EOS_CONFIG = {
  contractName: "todoaccount", // Contract name
  contractSender: "todoaccount", // User executing the contract (should be paired with private key)
  clientConfig: {
    keyProvider: ['5K7mtrinTFrVTduSxizUc5hjXJEtTjVTsqSHeBHes1Viep86FP5'], // Your private key
...
class TodoList extends React.Component {
  ...
  loadTodos() {
    this.eosClient.getTableRows('todoaccount', 'todoaccount', 'todo').then((data) => {
